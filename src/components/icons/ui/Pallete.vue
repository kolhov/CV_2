<template>
  <svg
    ...
    viewBox="0 0 24 24"
  >
    <mask id="SVGIHQypetX" fill="#fff">
      <path d="M11.085 7a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0" />
    </mask>
    <mask id="SVGjXBqqeYj" fill="#fff">
    ...
    <g fill="none" stroke="currentColor" stroke-width="1">
      ...
      />
      <circle cx="17.5" cy="11.5" r=".75" stroke-width="1.5" />
      <circle cx="6.5" cy="11.5" r=".75" stroke-width="1.5" />
      <path
        stroke-width="3"
        d="M11.085 7a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0Z"
        mask="url(#SVGIHQypetX)"
      />
      <path
        stroke-width="3"
        d="M16 7a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0Z"
        mask="url(#SVGjXBqqeYj)"
      />
    </g>
  </svg>
</template>
